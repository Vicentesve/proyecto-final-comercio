...
function Ticket({
  ...
  return (
    <div ref={componentRef} className="w-full">
      ...
      <div className=" bg-white border-r-transparent border-l border-l-[#c7bbbb] w-8 rounded-full h-8  absolute top-[295px] -right-5 z-80"></div>
      <div className="absolute z-100 top-[295px] left-[20px] text-sm text-gray-600 overflow-hidden">
        {Array.from({ length: width / 4.5 }, (_, i) => ".")}
      </div>
      <div className=" bg-white border-l-transparent border-r border-r-[#c7bbbb] w-8 rounded-full h-8  absolute top-[295px] -left-5 z-80"></div>
    </div>
  );
}
