<div className="sm:hidden flex items-center justify-between p-2 bg-[#232F3E] text-white">
      ...
      <div className="hidden p-3 bg-[#232F3E] text-white md:flex justify-between items-center">
        <div className="flex ">
          ...
          <div className="ml-10 flex mt-2 space-x-10 sm:space-x-8">
            <div
              onClick={() => {
                if (session) {
        ...
        <div className="hover:underline flex items-center space-x-2 cursor-pointer whitespace-nowrap">
